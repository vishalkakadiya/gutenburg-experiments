...
( function() {
     ...
     */
    registerBlockType(
        'vk/static-block-example', // Block name. Must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
        {
            title: __( 'VK Static Block Example' ), // Block title. __() function allows for internationalization.
            ...
            edit: function( props ) {
                return createElement(
                    ...
                    'VK Static block example.' // Block content
                );
            },
